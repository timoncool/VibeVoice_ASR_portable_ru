...
- Эмуляция 4-bit квантизации для экономии видеопамяти
...
1. Клонируйте репозиторий: `git clone https://github.com/timoncool/VibeVoice_ASR_portable_ru.git`
...
- HuggingFace Xet для быстрой загрузки моделей
...
<a href="https://github.com/timoncool/VibeVoice_ASR_portable_ru/stargazers">
 <picture>
